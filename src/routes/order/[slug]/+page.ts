...
// }
import { DefaultOrderForm } from './../../../types/type.GenericOrderForm';
export function load({ params }) {
  ...
  const testForm = new DefaultOrderForm({
    ...
    maxColors: maxColors,
    startingPrice: 1.11,
    count: { index: 0, id: "count", title: "Count | ", minimum: 0, options: [{ index: 0, name: "", price: -1 }] },
    colors: {
      index: 1,
      id: "colors",
      title: "Colors",
    ...
    style: { index: 2, id: "style", title: "Style", options: [{ index: 0, name: "Simple | Yet beautiful! Stylishly decorated and an eye-catching presentation.", price: 1 }] },
    addOns: { index: 3, id: "addons", title: "Add-ons", description: "" },
    comments: { index: 4, id: "comments", title: "Final Comments, Questions, or Ideas?", description: "" },
    nonDefaultOptions: [
      { key: "layers", index: 5, id: "layers", title: "Layers | Per Tier", options: [{ index: 0, name: "2", price: 1 }] },
